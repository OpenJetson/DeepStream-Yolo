...
### [YoloV4 configuration for DeepStream](https://github.com/marcoslucianops/DeepStream-Yolo/blob/master/YOLOV4.md) *(Not official)*
### [YoloV5 configuration for DeepStream](https://github.com/marcoslucianops/DeepStream-Yolo/blob/master/YOLOV5.md) *(Not official)*
